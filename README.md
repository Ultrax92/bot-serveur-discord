...
| ⏰ Messages programmés | ✅ Fait | `/schedule` : embeds récurrents publiés automatiquement (annonce hebdo, rappel feedback…) — nom, titre, message, mention @everyone/@here/rôle au-dessus de l'embed, intervalle libre (min 10m), date du prochain envoi réglable (JJ/MM/AAAA HH:MM), envoi test, pause/reprise, salon par sélecteur ou ID, rattrapage sans spam après un arrêt du bot, inclus dans les backups |
