...
const TABLE_COLUMNS = {
  ...
  ticket_reviews: ['id', 'guild_id', 'user_id', 'ticket_number', 'type_id', 'type_label', 'status', 'stars', 'comment', 'auto', 'dm_channel_id', 'dm_message_id', 'review_channel_id', 'review_message_id', 'deadline', 'transcript', 'created_at'],
};
